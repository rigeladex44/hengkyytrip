...
export default function WhatsAppButton() {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-6 right-6 z-50 w-12 h-12 bg-gradient-to-r from-green-500 to-green-600 rounded-full flex items-center justify-center shadow-lg glow-hover"
    >
